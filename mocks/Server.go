...
// Open provides a mock function with given fields: sd, path, readOnly, events
func (_m *Server) Open(sd server.SessionDescriptor, path string, readOnly bool, events server.EventsConfig) (server.NodeDescriptor, error) {
	ret := _m.Called(sd, path, readOnly, events)
